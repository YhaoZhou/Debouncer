...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/ec67/hdl" +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/ec67/hdl" +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_vip_v1_1_15 $xmvlog_opts -sv +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/ec67/hdl" +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work zynq_ultra_ps_e_vip_v1_0_15 $xmvlog_opts -sv +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/ec67/hdl" +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/2fcd/hdl/zynq_ultra_ps_e_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/ec67/hdl" +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.Debouncing_BD xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.Debouncing_BD -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log Debouncing_BD_sc.so .tmp_log xcelium_lib waves.shm c.obj)
