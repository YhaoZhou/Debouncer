...
#
# Script generated by Vivado on Thu Apr 04 11:08:01 +0200 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Debouncing_BD.sh
...
#
# Usage        : Debouncing_BD.sh
#                Debouncing_BD.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Debouncing_BD.sh [-reset_run]
#                Debouncing_BD.sh [-reset_log]
#                Debouncing_BD.sh [-help]
#
...
#                script (type 'Debouncing_BD.sh -help' for more information).
#
...
# script info
echo -e "Debouncing_BD.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Debouncing_BD.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/ec67/hdl" +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/ec67/hdl" +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_vip_v1_1_15 $vlogan_opts -sverilog +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/ec67/hdl" +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work zynq_ultra_ps_e_vip_v1_0_15 $vlogan_opts -sverilog +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/ec67/hdl" +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/2fcd/hdl/zynq_ultra_ps_e_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/ec67/hdl" +incdir+"../../../../Debouncing.gen/sources_1/bd/Debouncing_BD/ipshared/2fcd/hdl" +incdir+"D:/vivado/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Debouncing_BD xil_defaultlib.glbl -o Debouncing_BD_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Debouncing_BD_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Debouncing_BD_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Debouncing_BD_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Debouncing_BD.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Debouncing_BD.sh [-help]\n\
Usage: Debouncing_BD.sh [-step]\n\
Usage: Debouncing_BD.sh [-lib_map_path]\n\
Usage: Debouncing_BD.sh [-reset_run]\n\
Usage: Debouncing_BD.sh [-reset_log]\n\
Usage: Debouncing_BD.sh [-keep_index]\n\
Usage: Debouncing_BD.sh [-noclean_files]\n\n\
